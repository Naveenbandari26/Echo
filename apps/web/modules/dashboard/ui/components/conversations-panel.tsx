                    ...
                    {conversations.results.map((conversation)=>{
                        ...
                        return (
                            <Link 
                                ...
                                className={cn(
                                    "relative flex curson-pointer items-start gap-3 border-b p-4 py-5 text-sm leading-tight hover:bg-accent hover:text-accent-foreground",
...
export const SkeletonConversations=()=>{
    return(
        <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-auto">
            <div className="relative flex w-full min-w-0 lex-col p-2">
                <div className="w-full space-y-2">
                    {Array.from({length:8}).map((_,index)=>(
                        <div className="flex items-center gap-3 rounded-lg p-4" key={index}>
