...
import { enhanceResponce } from "@workspace/backend/private/messages"
...
export const ConversationIdView = ({ conversationId }: { conversationId: Id<"conversations"> }) => {
    ...
    const ehnanceResponce=useAction(api.private.messages.enhanceResponce);
    const handleEnhanceResponse= async()=>{
        setIsEnhancing(true)
        const value=form.getValues("message")
        try{
            const response=await ehnanceResponce({
                prompt: value
            })
...
export const ConversationIdViewLoading=()=>{
    return(
        <div className="flex h-full flex-col bg-muted">
            ...
            <AIConversation className="max-h-[calc(100vh-180px)]">
                <AIConversationContent>
                    {Array.from({length:8},(_,index)=>{
                        ...
                        return(
                            <div 
                                className={cn("group flex w-full items-end justify-end gap-2 py-2 [&>div]:max-w-[80%]",
            ...
            <div className="p-2">
                    <AIInput>
                        <AIInputTextarea disabled placeholder="Type your responce as an operator..."/>
                        <AIInputToolbar>
                            <AIInputTools/>
